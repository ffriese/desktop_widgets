...
class AllDayWidget(TimelineWidget):
        ...
        if self.bg_widgets:
            for ev in self.cal_events.values():
                try:
                    ...
                    pass
            CalendarHelper.scale_events([c for c in self.cal_events.values() if c.isVisible()],
    ...
    def delete_event_callback(self):
        ...
        self._h = 25
        CalendarHelper.scale_events([c for c in self.cal_events.values() if c.isVisible()], self.width(),
